...
contract CSAMM {
    ...
    function swap(
        ...
        require(_tokenIn == address(token0) || _tokenIn == address(token1), "tokenIn is not support");
        ...
        (IERC20 tokenIn, IERC20 tokenOut, uint256 resIn, uint256 resOut) = isToken0 ?
         ...
         (uint256 res0, uint256 res1) = isToken0 ? (resIn + _amount, resOut - amountOut) : (resOut - amountOut, resIn + _amount);
